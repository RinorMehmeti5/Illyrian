      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <motion.div variants={childVariants}>
            <h3 className="text-lg font-semibold mb-4 text-[#FFFDF2]">
              {t("About Us")}
            </h3>
              ...
              {[
                ...
                <motion.li key={index} initial="initial" whileHover="hover">
                  <motion.div variants={linkHoverVariants}>
                    <Link
                      to={link.path}
                      className="text-gray-400 hover:text-[#FFFDF2] transition flex items-center"
                    >
                      <span>→</span>
          ...
          <motion.div variants={childVariants}>
            ...
            <ul className="space-y-3 text-gray-400">
              <motion.li whileHover={{ x: 5 }} className="flex items-start">
                <svg
                  className="h-5 w-5 mr-2 mt-0.5 text-[#FFFDF2]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <motion.div variants={childVariants}>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 w-full rounded-l outline-none text-black bg-white"
              />
              <motion.button
                type="submit"
                className="bg-[#FFFDF2] hover:bg-white px-4 py-2 rounded-r text-black transition"
        ...
        >
          {[
            ...
            <motion.a
              key={index}
              href={social.path}
              className="text-gray-400 hover:text-[#FFFDF2]"
